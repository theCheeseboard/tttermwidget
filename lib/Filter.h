...
namespace Konsole {
     ...
     */
    class TTTERMWIDGET_EXPORT Filter : public QObject {
        public:
            /**
     ...
     * are found.
     */
    class TTTERMWIDGET_EXPORT RegExpFilter : public Filter {
        public:
            /**
    ...
    class TTTERMWIDGET_EXPORT UrlFilter : public RegExpFilter {
            Q_OBJECT
        public:
            /**
    ...
    class TTTERMWIDGET_NO_EXPORT FilterObject : public QObject {
            Q_OBJECT
        public:
     ...
     */
    class TTTERMWIDGET_EXPORT FilterChain : protected QList<Filter*> {
        public:
            virtual ~FilterChain();
    ...
    class TTTERMWIDGET_NO_EXPORT TerminalImageFilterChain : public FilterChain {
        public:
